...
#define PWM_LED3_NODE_ID DT_ALIAS(pwm_led3)
...
#define PWM3_CTLR DT_PWMS_CTLR(PWM_LED3_NODE_ID)
...
#define PWM3_CHANNEL DT_PWMS_CHANNEL(PWM_LED3_NODE_ID)
// diff for all
...
#define PWM3_FLAGS DT_PWMS_FLAGS(PWM_LED3_NODE_ID)
// same for all?
